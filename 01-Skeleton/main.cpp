...
void LoadResources()
{
	...
	temp = new CMario(MARIO_TEXTURE_PATH);
	temp->SetPosition(10.0f, 130.0f);
	objects.push_back(temp);

	temp = new CMario(MARIO_TEXTURE_PATH);
	temp->SetPosition(20.0f, 130.0f);
	objects.push_back(temp);

	temp = new CbrickObject(BRICK_TEXTURE_PATH);
	temp->SetPosition(10.0f, 100.0f);
	objects.push_back(temp);
